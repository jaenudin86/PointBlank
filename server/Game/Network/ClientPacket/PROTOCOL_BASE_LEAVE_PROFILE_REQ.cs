...
{
    class PROTOCOL_BASE_LEAVE_PROFILE_REQ : ReceivePacket
    {
        public PROTOCOL_BASE_LEAVE_PROFILE_REQ(GameNetwork Client, byte[] data)
        {
            makeme(Client, data);
        }
        ...
        public override void RunImpl()
        {
            ...
            getClient().SendPacket(new PROTOCOL_BASE_LEAVE_PROFILE_ACK());
        }
    }
}
